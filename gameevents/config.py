...
SQLALCHEMY_DATABASE_URI = "postgresql://gameevents:gameevents@localhost/gameevents"
...
SQLALCHEMY_DATABASE_URI_TEST = "postgresql://gameevents:gameevents@localhost/gameevents_test"
